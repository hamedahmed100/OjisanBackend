...
namespace OjisanBackend.Infrastructure.Migrations
{
    ...
    [Migration("20260308140453_AddOrderFulfillmentAndSingleOrderPayment")]
    partial class AddOrderFulfillmentAndSingleOrderPayment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OjisanBackend.Domain.Entities.MediaLibrary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OjisanBackend.Domain.Entities.MediaLibraryImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OjisanBackend.Domain.Entities.ProductMediaLibrary", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ProductId", "MediaLibraryId");

                    b.HasIndex("MediaLibraryId");

                    b.HasIndex("ProductId");

                    b.ToTable("ProductMediaLibraries");
                });
            ...
            modelBuilder.Entity("OjisanBackend.Domain.Entities.MediaLibraryImage", b =>
                {
                    b.HasOne("OjisanBackend.Domain.Entities.MediaLibrary", "MediaLibrary")
                        .WithMany("Images")
